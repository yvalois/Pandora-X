      ...
      switch ((_context.prev = _context.next)) {
        case 0:
          ...
          return regeneratorRuntime.awrap(
            NFTROLPROVIDER.mint(address, type, range)
          );
        ...
        case 4:
          ...
          _context.next = 7;
          return regeneratorRuntime.awrap(
            provider.waitForTransaction(tx.hash, 3)
          );
...
var exist = function exist(address) {
  var signer, NFTROLPROVIDER, _exist;

  return regeneratorRuntime.async(function exist$(_context4) {
    while (1) {
      switch ((_context4.prev = _context4.next)) {
        case 0:
          ...
          NFTROLPROVIDER = NFTROL.connect(signer);
          _context4.next = 4;
          return regeneratorRuntime.awrap(NFTROLPROVIDER.exist(address));

        case 4:
          _exist = _context4.sent;
          return _context4.abrupt('return', _exist);
