...
function ModalWithdraw() {
        ...
        switch (_a.label) {
          case 0:
            ...
            return [
              4,
              /*yield*/
              inversionMinter.getPricePlusFee(_id),
            ];
  ...
  var verifyApprove = function verifyApprove() {
    return __awaiter(_this, void 0, void 0, function () {
      var usdt, e_1;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4,
              /*yield*/
              usdtContract.allowance(accountAddress, staking.address),
            ];

          case 1:
            usdt = _a.sent(); //MarketPlace
