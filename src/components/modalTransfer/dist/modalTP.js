...
function ModalTP() {
  ...
  var verifyApprove = function () {
    return __awaiter(_this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, productoMinter.getApproved(id)];
          case 1:
            isap = _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            setLoading(true);
            setError('');
            return [4 /*yield*/, productoMinter.approve(value, id)];
          case 1:
            tx = _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              productoMinter.transferFrom(accountAddress, value, id),
            ];
          case 1:
            tx = _a.sent();
            return [4 /*yield*/, tx.wait()];
  ...
  react_1.useEffect(function () {
    var _id = window.localStorage.getItem('TransferPId');
    setId(_id);
  }, []);
  react_1.useEffect(
    function () {
