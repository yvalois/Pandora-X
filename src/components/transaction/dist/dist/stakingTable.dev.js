...
function StakingTable() {
  ...
  var claim = function claim(value) {
        ...
        switch (_a.label) {
          ...
          case 3:
            ...
            return [
              4,
              /*yield*/
              staking.claimReward(value, usdtContract.address),
            ];
  ...
  var setStakings = function setStakings() {
    return __awaiter(_this, void 0, void 0, function () {
      var count, i, _loop_1;
        ...
        switch (_a.label) {
          case 0:
            return [
              4,
              /*yield*/
              inversionMinter.getCountOfStaking(),
            ];
                ...
                switch (_a.label) {
                  ...
                  case 3:
                    ...
                    return [
                      4,
                      /*yield*/
                      inversionMinter.getDate(indice),
                    ];
                  ...
                  case 4:
                    ...
                    return [
                      4,
                      /*yield*/
                      inversionMinter.getApr(),
                    ];

                  case 5:
                    apr = _a.sent(); //const valor1 =  await inversionMinter.
                    //const balance =;
