...
var _retro_1 = require('@/layouts/_retro');
...
var price_feed_retro_1 = require('@/data/static/price-feed-retro');
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(live_price_feed_1['default'], {
          priceFeeds: price_feed_retro_1.priceFeedData,
          limit: 3,
...
Retro.getLayout = function getLayout(page) {
  return React.createElement(_retro_1['default'], null, page);
};
