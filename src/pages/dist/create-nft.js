...
var CreateNFTPage = function () {
  ...
  var createNFTs = function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var i, txResult, NFT, i, txResult, NFT;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!(tipo.value == 'productos')) return [3 /*break*/, 9];
            i = void 0;
            return [4 /*yield*/, productoMinter.Mint(supply, price)];
          case 1:
            txResult = _a.sent();
          ...
          case 2:
            _a.sent();
            console.log(txResult);
            if (!(txResult.status == 1)) return [3 /*break*/, 7];
            i = 0;
            _a.label = 3;
          case 3:
            if (!(i < supply)) return [3 /*break*/, 6];
            NFT = {
          ...
          case 8:
            return [3 /*break*/, 17];
          case 9:
            if (!(tipo.value === 'inversion')) return [3 /*break*/, 17];
            i = void 0;
            return [
              4 /*yield*/,
              inversionMinter.Mint(supply, price, tipoInv.value),
            ];
          case 10:
            txResult = _a.sent();
            return [4 /*yield*/, txResult.wait()];
          case 11:
            _a.sent();
            if (!(txResult.status == 1)) return [3 /*break*/, 16];
            i = 0;
            _a.label = 12;
          case 12:
            if (!(i < supply)) return [3 /*break*/, 15];
            NFT = {
  ...
  return React.createElement(
    ...
    status == 200 &&
      React.createElement(
        ...
        {
          className:
            'p-4 mb-4 text-sm w-[300px] self-center justify-center absolute top-24 right-[680px] mt-[0px] text-green-700 bg-green-200 rounded-lg dark:bg-green-200 dark:text-green-800',
          role: 'alert',
        },
        React.createElement(
          'span',
    ...
    status == 100 &&
      React.createElement(
        ...
        {
          className:
            'p-4 mb-4 text-sm w-[300px] absolute top-24 right-[680px] mt-[0px] self-center justify-center  text-red-700 bg-red-200 rounded-lg dark:bg-red-200 dark:text-red-800',
          role: 'alert',
        },
        React.createElement(
          'span',
