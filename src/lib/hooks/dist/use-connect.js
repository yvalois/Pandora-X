...
exports.WalletProvider = function (_a) {
    ...
    var _b = react_1.useState(undefined), address = _b[0], setAddress = _b[1];
    var _c = react_1.useState(undefined), balance = _c[0], setBalance = _c[1];
    ...
    var web3Modal = typeof window !== 'undefined' && new web3modal_1["default"]({ cacheProvider: true, providerOptions: providerOptions }); //agregar provider options
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!localStorage.getItem(web3modalStorageKey)) return [3 /*break*/, 2];
    ...
    var setWalletAddress = function (provider) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var getBalance = function (provider, walletAddress) { return __awaiter(void 0, void 0, void 0, function () {
        var walletBalance, balanceInEth;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, provider.getBalance(walletAddress)];
                case 1:
    ...
    var connectToWallet = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    error_3 = _b.sent();
                    setLoading(false);
                    console.log(error_3, 'got this error on connectToWallet catch block while connecting the wallet');
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/];
            }
        });
    }); };
    var subscribeProvider = function (connection) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            connection.on('close', function () {
                disconnectWallet();
            });
            connection.on('accountsChanged', function (accounts) { return __awaiter(void 0, void 0, void 0, function () {
                var provider;
                return __generator(this, function (_a) {
    ...
    return (React.createElement(exports.WalletContext.Provider, { value: {
            address: address,
            balance: balance,
            loading: loading,
            error: error,
