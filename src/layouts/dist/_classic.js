...
var _expandable_icon_1 = require('@/layouts/sidebar/_expandable-icon');
...
function Header() {
  ...
  return React.createElement(
    ...
    {
      className:
        'fixed top-0 z-30 w-full transition-all duration-300 ltr:right-0 rtl:left-0 ltr:xl:pl-28 rtl:xl:pr-28 ltr:2xl:pl-28 rtl:2xl:pr-28 ' +
    ...
    React.createElement(
      ...
      {
        className:
          'flex h-full items-center justify-between px-4 sm:px-6 lg:px-8 xl:px-10 3xl:px-12',
      },
      React.createElement(
        'div',
...
function Layout(_a) {
  ...
  return React.createElement(
    'div',
    { className: 'ltr:xl:pl-28 rtl:xl:pr-28 ltr:2xl:pl-28 rtl:2xl:pr-28' },
    React.createElement(Header, null),
    React.createElement(_expandable_icon_1['default'], {
