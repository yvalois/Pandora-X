...
var _default_1 = require('@/layouts/sidebar/_default');
...
function Header() {
  ...
  return React.createElement(
    ...
    {
      className:
        'fixed top-0 z-30 w-full transition-all duration-300 ltr:right-0 rtl:left-0 ltr:xl:pl-72 rtl:xl:pr-72 ltr:2xl:pl-80 rtl:2xl:pr-80 ' +
...
function Layout(_a) {
  ...
  return React.createElement(
    ...
    React.createElement(_default_1['default'], {
